...
public class ServerNodeSpringStartup {
	...
	private static final String[] CACHES = { "FeedSapEmployeeCache", "SapEmployeeGroupCache",
			"SapEmployeeSubGroupCache", "SapEntityCache", "SapLocationCache", "SapOrgDepartmentCache",
			"SapOrgUnitCache", "SapStaffCache" };
